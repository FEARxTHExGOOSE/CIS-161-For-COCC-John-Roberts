...
'''This function takes a users entry, and gives an equivalent number of stars printed in
descending order till nothing is printed, using iteration.'''
...
'''This function takes a users entry, and gives an equivalent number of stars printed in
descending order till nothing is printed, using recursion.'''
